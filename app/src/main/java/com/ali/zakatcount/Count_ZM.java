...
public class Count_ZM extends AppCompatActivity {
    ...
    //hukum islamnya nishabnya  20dinar = 80gr emas murni
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                long jumlahHarta = Integer.parseInt(edtJumlahHarta.getText().toString());
                ...
                if (jumlahHarta<convertedNishab){
                    ...
                    //kesepaatan ulama ketika sudah melewati nishab, zakat yang harus di keluarkan
